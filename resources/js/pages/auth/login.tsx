            ...
            <div className="flex items-center justify-center p-6 sm:p-8 bg-[#0D0D0D] min-h-screen lg:min-h-0">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-[#161616] border border-[#2A2A2A] rounded-2xl p-8 sm:p-10 w-full shadow-sm">
                        {/* Header */}
                        <div>
                            <h1 className="font-display font-black text-3xl text-[#F5F5F5] tracking-tight">
                                Sign In
                            </h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-3 top-1/2 -translate-y-1/2 text-[#9A9A9A] hover:text-[#F5F5F5] transition-colors"
                            ...
                            <div className="flex items-center justify-between pt-1">
                                <div className="flex items-center gap-2">
                                    ...
                                    <Label
                                        htmlFor="remember"
                                        className="text-sm text-[#9A9A9A] cursor-pointer font-normal"
                                    >
                                        Remember me
                                    </Label>
                                </div>
                        ...
                        <div className="relative my-7">
                            ...
                            <div className="relative flex justify-center">
                                <span className="bg-[#161616] px-3 text-xs text-[#555555] uppercase tracking-widest font-semibold">
                                    or
                                </span>
                            </div>
                        </div>
