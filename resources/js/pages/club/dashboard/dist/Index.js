...
function FilterPanel(_a) {
    ...
    return (react_1["default"].createElement("div", { className: "space-y-6" },
        react_1["default"].createElement("div", { className: "flex items-center justify-between" },
            ...
            react_1["default"].createElement("button", { className: "text-[#E53F01] text-xs hover:underline font-semibold" }, "Clear All")),
        ...
        react_1["default"].createElement("div", { className: "space-y-3" },
            ...
            react_1["default"].createElement("div", { className: "space-y-2.5" }, POSITIONS.map(function (p) { return (react_1["default"].createElement("div", { key: p.code, className: "flex items-center gap-2.5" },
                react_1["default"].createElement(checkbox_1.Checkbox, { id: "pos-" + p.code, className: "border-[#CBD5E1] dark:border-[#2A2A2A] data-[state=checked]:bg-[#E53F01] data-[state=checked]:border-[#E53F01]" }),
                react_1["default"].createElement(label_1.Label, { htmlFor: "pos-" + p.code, className: "flex-1 flex items-center justify-between text-sm font-normal text-[#0F172A] dark:text-[#F5F5F5] cursor-pointer" },
                    react_1["default"].createElement("span", null,
                        react_1["default"].createElement("span", { className: "font-mono font-bold text-[#E53F01]" }, p.code),
        ...
        react_1["default"].createElement("div", { className: "space-y-3" },
            react_1["default"].createElement("div", { className: "flex items-center justify-between" },
                ...
                react_1["default"].createElement("span", { className: "font-mono text-[#E53F01] text-sm font-semibold" },
                    ageMin,
                    " \u2013 ",
                    ageMax)),
            react_1["default"].createElement("div", { className: "space-y-2 pt-1" },
                react_1["default"].createElement("input", { type: "range", min: 16, max: 40, value: ageMin, onChange: function (e) { return setAgeMin(Math.min(Number(e.target.value), ageMax)); }, className: "w-full h-1.5 bg-[#E2E8F0] dark:bg-[#2A2A2A] rounded-lg appearance-none cursor-pointer accent-[#E53F01]" }),
                react_1["default"].createElement("input", { type: "range", min: 16, max: 40, value: ageMax, onChange: function (e) { return setAgeMax(Math.max(Number(e.target.value), ageMin)); }, className: "w-full h-1.5 bg-[#E2E8F0] dark:bg-[#2A2A2A] rounded-lg appearance-none cursor-pointer accent-[#E53F01]" })),
        ...
        react_1["default"].createElement("div", { className: "space-y-3" },
            ...
            react_1["default"].createElement("div", { className: "relative" },
                ...
                react_1["default"].createElement(input_1.Input, { value: countrySearch, onChange: function (e) { return setCountrySearch(e.target.value); }, placeholder: "Search country...", className: "pl-9 h-9 text-sm bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:border-[#E53F01] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 dark:focus-visible:ring-1" })),
            react_1["default"].createElement("div", { className: "space-y-1.5 max-h-44 overflow-y-auto pr-1" }, COUNTRIES.filter(function (c) {
                ...
                react_1["default"].createElement(checkbox_1.Checkbox, { id: "country-" + c.name, className: "border-[#CBD5E1] dark:border-[#2A2A2A] data-[state=checked]:bg-[#E53F01] data-[state=checked]:border-[#E53F01]" }),
        ...
        react_1["default"].createElement("div", { className: "space-y-3" },
            ...
            react_1["default"].createElement(radio_group_1.RadioGroup, { value: preferredFoot, onValueChange: setPreferredFoot, className: "space-y-2" }, ['any', 'right', 'left', 'both'].map(function (foot) { return (react_1["default"].createElement("div", { key: foot, className: "flex items-center gap-2.5" },
                react_1["default"].createElement(radio_group_1.RadioGroupItem, { id: "foot-" + foot, value: foot, className: "border-[#CBD5E1] dark:border-[#2A2A2A] text-[#E53F01]" }),
        ...
        react_1["default"].createElement("div", { className: "space-y-3" },
            ...
            react_1["default"].createElement("div", { className: "space-y-2.5" }, ['Football', 'Futsal', 'Beach Soccer'].map(function (m) { return (react_1["default"].createElement("div", { key: m, className: "flex items-center gap-2.5" },
                react_1["default"].createElement(checkbox_1.Checkbox, { id: "mod-" + m, defaultChecked: m === 'Football', className: "border-[#CBD5E1] dark:border-[#2A2A2A] data-[state=checked]:bg-[#E53F01] data-[state=checked]:border-[#E53F01]" }),
        ...
        react_1["default"].createElement("div", { className: "space-y-3" },
            ...
            react_1["default"].createElement("div", { className: "flex items-center gap-2" },
                react_1["default"].createElement(input_1.Input, { type: "number", value: heightMin, onChange: function (e) { return setHeightMin(e.target.value); }, placeholder: "Min", className: "h-9 text-sm font-mono bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:border-[#E53F01] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 dark:focus-visible:ring-1" }),
                react_1["default"].createElement("span", { className: "text-[#94A3B8] text-sm" }, "\u2013"),
                react_1["default"].createElement(input_1.Input, { type: "number", value: heightMax, onChange: function (e) { return setHeightMax(e.target.value); }, placeholder: "Max", className: "h-9 text-sm font-mono bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:border-[#E53F01] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 dark:focus-visible:ring-1" }))),
        react_1["default"].createElement(separator_1.Separator, { className: "bg-[#E2E8F0] dark:bg-[#2A2A2A]" }),
        react_1["default"].createElement("div", { className: "space-y-3" },
            ...
            react_1["default"].createElement("div", { className: "flex items-center gap-2.5" },
                react_1["default"].createElement(checkbox_1.Checkbox, { id: "premium-only", className: "border-[#CBD5E1] dark:border-[#2A2A2A] data-[state=checked]:bg-[#E53F01] data-[state=checked]:border-[#E53F01]" }),
                react_1["default"].createElement(label_1.Label, { htmlFor: "premium-only", className: "text-sm font-normal text-[#0F172A] dark:text-[#F5F5F5] cursor-pointer flex items-center gap-1.5" },
                    react_1["default"].createElement(lucide_react_1.Star, { className: "w-3.5 h-3.5 text-[#E53F01] fill-[#E53F01]" }),
                    "Premium players only"))),
        react_1["default"].createElement(button_1.Button, { className: "w-full h-11 bg-[#E53F01] hover:bg-[#E53F01] text-white rounded-xl font-semibold mt-2" }, "Apply Filters"),
        react_1["default"].createElement("div", { className: "space-y-2 pt-2" },
            ...
            react_1["default"].createElement("div", { className: "bg-gradient-to-br from-[#0F172A] to-[#1E293B] rounded-xl h-[240px] p-5 flex flex-col items-center justify-center text-center border border-[#334155] relative overflow-hidden" },
                ...
                react_1["default"].createElement("div", { className: "w-14 h-14 rounded-full bg-[#E53F01]/20 border border-[#E53F01]/40 flex items-center justify-center mb-3" },
                    react_1["default"].createElement(lucide_react_1.Network, { className: "w-7 h-7 text-[#E53F01]", strokeWidth: 2.2 })),
                ...
                react_1["default"].createElement("button", { className: "bg-[#E53F01] hover:bg-[#E53F01] text-white text-xs font-bold uppercase tracking-wider px-5 py-2 rounded-lg transition-colors" }, "Join Free")))));
}
function Index() {
            ...
            react_1["default"].createElement("main", { className: "flex-1 min-w-0 p-4 sm:p-6" },
                react_1["default"].createElement("div", { className: "bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-4 mb-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3" },
                    react_1["default"].createElement("div", { className: "relative flex-1" },
                        ...
                        react_1["default"].createElement(input_1.Input, { value: searchQuery, onChange: function (e) { return setSearchQuery(e.target.value); }, placeholder: "Search by name, club, or nationality...", className: "pl-10 h-11 bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] placeholder:text-[#94A3B8] dark:placeholder:text-[#555555] focus-visible:border-[#E53F01] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 dark:focus-visible:ring-1" })),
                ...
                react_1["default"].createElement("div", { className: "mb-4" },
                    react_1["default"].createElement("div", { className: "bg-gradient-to-r from-[#0F172A] to-[#1E293B] rounded-xl min-h-[80px] flex flex-col sm:flex-row items-center px-6 py-3 sm:py-0 gap-3 sm:gap-4 border border-[#334155] relative overflow-hidden" },
                        ...
                        react_1["default"].createElement("div", { className: "flex items-center gap-3 shrink-0" },
                            react_1["default"].createElement("div", { className: "w-10 h-10 rounded-lg bg-gradient-to-br from-[#E53F01] to-[#E53F01] flex items-center justify-center font-display font-black text-white text-lg" }, "TR"),
                ...
                view === 'grid' && (react_1["default"].createElement("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4" }, players.map(function (p) { return (react_1["default"].createElement(react_2.Link, { key: p.id, href: "/scout/players/" + p.id, className: "bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl overflow-hidden cursor-pointer group transition-all hover:-translate-y-1 hover:shadow-[0_4px_20px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_4px_20px_rgba(255,107,0,0.08)] hover:border-[#E53F01]" },
                    react_1["default"].createElement("div", { className: "h-48 " + positionGradient(p.position) + " bg-[#F8FAFC] dark:bg-[#1F1F1F] relative flex items-center justify-center" },
                        react_1["default"].createElement("div", { className: "w-24 h-24 rounded-full bg-white/20 dark:bg-black/20 flex items-center justify-center font-display text-3xl font-black text-white/70" }, p.name
                            ...
                            .join('')
                            .slice(0, 2)),
                        react_1["default"].createElement("span", { className: "absolute top-3 left-3 bg-[#FFF3EB] dark:bg-[rgba(255,107,0,0.12)] border border-[#E53F01] text-[#E53F01] text-[10px] font-black px-2.5 py-0.5 rounded-full tracking-wider" }, p.position),
                        p.subscription === 'Premium' && (react_1["default"].createElement("span", { className: "absolute top-3 right-3 bg-[#E53F01] text-white text-[9px] font-black px-2 py-0.5 rounded-full tracking-wider flex items-center gap-1" },
                    ...
                    react_1["default"].createElement("div", { className: "p-5" },
                        ...
                        react_1["default"].createElement("p", { className: "mt-3 text-[#E53F01] text-xs font-bold tracking-wider group-hover:underline flex items-center gap-1" },
                            "VIEW PROFILE",
                        ...
                        react_1["default"].createElement(table_1.Table, null,
                            ...
                            react_1["default"].createElement(table_1.TableBody, null, players.map(function (p) { return (react_1["default"].createElement(table_1.TableRow, { key: p.id, className: "border-b border-[#F1F5F9] dark:border-[#1F1F1F] hover:bg-[#F8FAFC] dark:hover:bg-[#1A1A1A] transition-colors cursor-pointer" },
                                ...
                                react_1["default"].createElement(table_1.TableCell, null,
                                    react_1["default"].createElement("span", { className: "bg-[#FFF3EB] dark:bg-[rgba(255,107,0,0.12)] border border-[#E53F01] text-[#E53F01] text-[10px] font-black px-2 py-0.5 rounded-full tracking-wider" }, p.position)),
                                ...
                                react_1["default"].createElement(table_1.TableCell, null, p.subscription === 'Premium' ? (react_1["default"].createElement("span", { className: "inline-flex items-center gap-1 bg-[#E53F01] text-white text-[9px] font-black px-2 py-0.5 rounded-full tracking-wider" },
                                    react_1["default"].createElement(lucide_react_1.Star, { className: "w-2.5 h-2.5 fill-white" }),
                                ...
                                react_1["default"].createElement(table_1.TableCell, { className: "text-right" },
                                    react_1["default"].createElement(react_2.Link, { href: "/scout/players/" + p.id, className: "inline-flex items-center gap-1 text-[#E53F01] text-xs font-bold tracking-wider hover:underline" },
                                        "VIEW",
                                        react_1["default"].createElement(lucide_react_1.ChevronRight, { className: "w-3 h-3" }))))); })))))),
                react_1["default"].createElement("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between mt-6 gap-3" },
                    ...
                    react_1["default"].createElement(pagination_1.Pagination, { className: "mx-0 w-auto justify-end" },
                        react_1["default"].createElement(pagination_1.PaginationContent, null,
                            ...
                            react_1["default"].createElement(pagination_1.PaginationItem, null,
                                react_1["default"].createElement(pagination_1.PaginationLink, { href: "#", isActive: true, className: "bg-[#E53F01] text-white border-[#E53F01] hover:bg-[#E53F01] hover:text-white" }, "1")),
                            react_1["default"].createElement(pagination_1.PaginationItem, null,
