...
function Pricing() {
    ...
    return (React.createElement("div", { className: "min-h-screen bg-white dark:bg-[#0D0D0D]" },
        ...
        React.createElement("main", { className: "pt-16" },
            React.createElement("section", { className: "bg-[#E53F01] py-20 text-center px-6" },
            ...
            React.createElement("section", { className: "bg-[#F8FAFC] dark:bg-[#0D0D0D] py-16 px-6" },
                React.createElement("div", { className: "max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 items-start" }, plans.map(function (plan) {
                    ...
                    return (React.createElement("div", { key: plan.id, className: isPremium
                        ...
                        plan.badge && (React.createElement("div", { className: "absolute -top-4 left-1/2 -translate-x-1/2 bg-[#E53F01] text-white text-xs font-black px-5 py-1.5 rounded-full tracking-wide uppercase" }, plan.badge)),
                        ...
                        React.createElement("ul", { className: "space-y-3" },
                            plan.features.map(function (feat) { return (React.createElement("li", { key: feat, className: "flex items-start gap-3 text-sm text-[#0F172A] dark:text-[#F5F5F5]" },
                                React.createElement(lucide_react_1.CheckCircle2, { className: "w-4 h-4 mt-0.5 shrink-0 " + (isPremium ? 'text-[#E53F01]' : 'text-green-500') }),
                        ...
                        React.createElement("div", { className: "mt-8" }, isPremium ? (React.createElement(react_2.Link, { href: "/register?plan=premium", className: "bg-[#E53F01] text-white w-full h-12 font-bold rounded-xl hover:bg-[#E53F01] flex items-center justify-center transition-colors" }, plan.cta)) : (React.createElement(react_2.Link, { href: plan.id === 'agent' ? '/contact?plan=agent' : '/register', className: "w-full h-12 border border-[#E2E8F0] dark:border-[#2A2A2A] hover:border-[#E53F01] hover:text-[#E53F01] font-semibold rounded-xl flex items-center justify-center text-[#0F172A] dark:text-[#F5F5F5] transition-colors bg-white dark:bg-[#161616]" }, plan.cta)))));
                })),
                        ...
                        React.createElement(table_1.Table, null,
                            React.createElement(table_1.TableHeader, null,
                                React.createElement(table_1.TableRow, { className: "bg-[#F8FAFC] dark:bg-[#1F1F1F] hover:bg-[#F8FAFC] dark:hover:bg-[#1F1F1F] border-b border-[#E2E8F0] dark:border-[#2A2A2A]" },
                                    ...
                                    React.createElement(table_1.TableHead, { className: "text-[#E53F01] font-black text-sm text-center py-4" }, "Premium"),
            ...
            React.createElement("section", { className: "bg-[#F8FAFC] dark:bg-[#0D0D0D] py-12 text-center px-6 border-t border-[#E2E8F0] dark:border-[#2A2A2A]" },
                ...
                React.createElement("div", { className: "flex flex-wrap justify-center items-center gap-6 mt-8" },
                    React.createElement("div", { className: "flex items-center gap-2 text-sm text-[#0F172A] dark:text-[#F5F5F5]" },
                        React.createElement(lucide_react_1.RefreshCcw, { className: "w-4 h-4 text-[#E53F01]" }),
                        React.createElement("span", { className: "font-semibold" }, "Cancel Anytime")),
                    React.createElement("div", { className: "flex items-center gap-2 text-sm text-[#0F172A] dark:text-[#F5F5F5]" },
                        React.createElement(lucide_react_1.ShieldCheck, { className: "w-4 h-4 text-[#E53F01]" }),
                        React.createElement("span", { className: "font-semibold" }, "Secure Payment")),
                    React.createElement("div", { className: "flex items-center gap-2 text-sm text-[#0F172A] dark:text-[#F5F5F5]" },
                        React.createElement(lucide_react_1.CheckCircle2, { className: "w-4 h-4 text-[#E53F01]" }),
            ...
            React.createElement("section", { className: "bg-white dark:bg-[#111111] py-16 px-6" },
                React.createElement("div", { className: "max-w-[800px] mx-auto" },
                    React.createElement("div", { className: "text-center mb-10" },
                        React.createElement("div", { className: "text-[#E53F01] text-xs font-bold tracking-[0.2em] uppercase" }, "FAQ"),
                    ...
                    React.createElement(accordion_1.Accordion, { type: "single", collapsible: true, className: "w-full space-y-3" }, faqs.map(function (f, i) { return (React.createElement(accordion_1.AccordionItem, { key: i, value: "item-" + i, className: "bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-xl px-6 data-[state=open]:border-[#E53F01]/40" },
...
function renderCell(value, highlight) {
    ...
    if (typeof value === 'boolean') {
        return value ? (React.createElement(lucide_react_1.Check, { className: "w-5 h-5 mx-auto " + (highlight ? 'text-[#E53F01]' : 'text-green-500') })) : (React.createElement(lucide_react_1.XCircle, { className: "w-5 h-5 mx-auto text-[#94A3B8] dark:text-[#555555]" }));
    }
