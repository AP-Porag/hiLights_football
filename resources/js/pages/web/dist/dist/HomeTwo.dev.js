...
exports.__esModule = true; // const HomeTwo = () => {
//     const steps = [
//         {
//             icon: User,
//             step: "01",
...
var HomeTwo = function HomeTwo() {
  ...
  return react_1["default"].createElement("div", {
    ...
    className: "w-full max-w-screen-2xl mx-auto pt-16"
    ...
    className: "grid min-h-[380px] grid-cols-1 items-center sm:min-h-[440px] md:min-h-[520px] md:grid-cols-2 lg:min-h-[600px] xl:min-h-[660px]"
  }, react_1["default"].createElement("div", {
    className: "px-6 py-14 sm:px-10 md:py-20 lg:px-16"
  }, react_1["default"].createElement("div", {
    className: "max-w-xl"
  }, react_1["default"].createElement("h1", {
    className: "text-3xl font-extrabold uppercase leading-tight sm:text-4xl md:text-[42px] lg:text-5xl xl:text-6xl"
    ...
    className: "mt-6 max-w-lg text-sm leading-relaxed text-[#f4f4f4] sm:text-base xl:text-lg"
  }, "The platform that connects players, clubs, agents and scouts through videos, statistics and professional profiles."), react_1["default"].createElement("p", {
    className: "mt-4 max-w-lg border-l-2 border-[#b2300e] pl-3 text-sm leading-relaxed text-[#f4f4f4] sm:text-base xl:text-lg"
  }, "Show your talent to the world and increase your opportunities in football."), react_1["default"].createElement("div", {
    className: "mt-8 flex flex-wrap items-center gap-4"
  }, react_1["default"].createElement("button", {
    className: "flex cursor-pointer items-center justify-center gap-2 rounded-md bg-[#ea3905] px-4 py-3 text-xs font-semibold uppercase transition-all duration-300 hover:bg-orange-600 sm:text-sm lg:px-6 lg:py-3 lg:text-base"
    ...
    className: "flex cursor-pointer items-center justify-center gap-2 rounded-md border border-gray-600 px-4 py-3 text-xs font-semibold uppercase transition-all duration-300 hover:border-white sm:text-sm lg:px-6 lg:py-4 lg:text-base"
  }, react_1["default"].createElement(lucide_react_1.CirclePlay, {
    className: "h-5 w-5 shrink-0 lg:h-6 lg:w-6"
  }), react_1["default"].createElement("span", null, "Learn More"))))), react_1["default"].createElement("div", {
    ...
    className: "mb-6 text-2xl font-extrabold uppercase leading-tight sm:text-3xl lg:text-4xl"
    ...
    return react_1["default"].createElement("div", {
      ...
      className: "mb-1 text-base font-extrabold uppercase sm:text-lg md:text-xl lg:text-2xl"
    }, item.title), react_1["default"].createElement("p", {
      className: "text-sm leading-relaxed text-gray-300 sm:text-base lg:text-lg"
    }, item.desc))));
  })), react_1["default"].createElement("div", {
    className: "flex items-center gap-4 border-b border-[#1f1f1f] py-6 sm:grid sm:grid-cols-[70px_1fr_200px] md:grid-cols-[90px_1fr_300px] lg:grid-cols-[110px_1fr_320px]"
  }, react_1["default"].createElement("div", {
    className: "flex justify-center"
  }, react_1["default"].createElement("div", {
    className: "flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#e63e00] md:h-20 md:w-20"
    ...
    className: "text-base leading-tight font-bold sm:text-lg md:text-xl lg:text-2xl"
    ...
    className: "mt-3 max-w-xl text-xs leading-relaxed text-[#efefef] sm:text-sm md:text-base"
    ...
    className: "flex items-end justify-end lg:pr-4"
  }, react_1["default"].createElement("button", {
    className: "flex cursor-pointer items-center gap-2 rounded-xl border border-[#773a0c] px-4 py-2 transition hover:bg-[#ff6b00]/10 md:gap-4 lg:px-8 lg:py-4"
  }, react_1["default"].createElement(lucide_react_1.UserPlus, {
    className: "h-6 w-6 shrink-0 text-white md:h-8 md:w-8"
  }), react_1["default"].createElement("span", {
    className: "text-left text-xs font-bold uppercase sm:text-sm lg:text-base"
  }, react_1["default"].createElement("span", {
    ...
    className: "mx-auto mb-6 max-w-7xl overflow-x-hidden px-4 lg:px-13"
  }, react_1["default"].createElement("div", {
    ...
    className: "text-xs font-extrabold whitespace-nowrap text-[#222] uppercase md:text-sm lg:text-base"
  }, "Community Highlights")), react_1["default"].createElement("button", {
    className: "flex cursor-pointer items-center gap-2 rounded-[10px] bg-white px-4 py-2 text-[10px] font-bold whitespace-nowrap text-gray-700 uppercase shadow-[0_4px_20px_rgba(0,0,0,0.08)] md:text-xs lg:text-sm"
    ...
    return react_1["default"].createElement(react_2.Link, {
      ...
      className: "text-sm font-bold whitespace-nowrap text-[#222] md:text-[15px] lg:text-base"
    }, player.name), react_1["default"].createElement("p", {
      className: "text-xs whitespace-nowrap text-gray-600 md:text-sm"
      ...
      svg: true,
      className: "mt-[2px] mr-1 md:mt-1"
    })), react_1["default"].createElement("span", {
      className: "text-xs whitespace-nowrap text-gray-700 md:text-sm"
    }, player.country))), react_1["default"].createElement("div", {
      className: "mr-3 flex items-center justify-center gap-2 text-xs whitespace-nowrap text-[#222] md:text-sm lg:text-base"
      ...
      className: "flex items-center justify-end gap-2 text-xs whitespace-nowrap text-[#222] md:ml-4 md:text-sm lg:text-base"
