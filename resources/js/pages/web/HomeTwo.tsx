...
const HomeTwo = () => {
    ...
    return (
        <div className="bg-black text-[#0F172A] dark:bg-[#0D0D0D] dark:text-[#F5F5F5]">
            <PublicNavbar />
            <main className="w-full max-w-screen-2xl mx-auto pt-16">
                ...
                >
                    <div className="grid min-h-[380px] grid-cols-1 items-center sm:min-h-[440px] md:min-h-[520px] md:grid-cols-2 lg:min-h-[600px] xl:min-h-[660px]">
                        {/* Left Content */}
                        <div className="px-6 py-14 sm:px-10 md:py-20 lg:px-16">
                            <div className="max-w-xl">
                                <h1 className="text-3xl font-extrabold uppercase leading-tight sm:text-4xl md:text-[42px] lg:text-5xl xl:text-6xl">
                                    <span className="block text-white">Be Seen.</span>
                                    <span className="block text-[#ee5e00]">
                                        Be Discovered <span className="text-white">!</span>
                                    </span>
                                ...
                                <p className="mt-6 max-w-lg text-sm leading-relaxed text-[#f4f4f4] sm:text-base xl:text-lg">
                                    The platform that connects players, clubs, agents and
                                    scouts through videos, statistics and professional
                                    profiles.
                                </p>

                                <p className="mt-4 max-w-lg border-l-2 border-[#b2300e] pl-3 text-sm leading-relaxed text-[#f4f4f4] sm:text-base xl:text-lg">
                                ...
                                <div className="mt-8 flex flex-wrap items-center gap-4">
                                    <button className="flex cursor-pointer items-center justify-center gap-2 rounded-md bg-[#ea3905] px-4 py-3 text-xs font-semibold uppercase transition-all duration-300 hover:bg-orange-600 sm:text-sm lg:px-6 lg:py-3 lg:text-base">
                                        <UserRoundPlus className="h-5 w-5 shrink-0 lg:h-6 lg:w-6" />
                                        <span className="text-left leading-tight">
                                            Create A Free
                                            <br /> Profile Now
                                        </span>
                                    </button>
                                    <button className="flex cursor-pointer items-center justify-center gap-2 rounded-md border border-gray-600 px-4 py-3 text-xs font-semibold uppercase transition-all duration-300 hover:border-white sm:text-sm lg:px-6 lg:py-4 lg:text-base">
                                        <CirclePlay className="h-5 w-5 shrink-0 lg:h-6 lg:w-6" />
                ...
                <section className="mx-auto max-w-7xl bg-black px-6 pt-10 text-white sm:px-10 lg:px-16">
                    <div>
                        {/* Heading */}
                        <h2 className="mb-6 text-2xl font-extrabold uppercase leading-tight sm:text-3xl lg:text-4xl">
                            A SIMPLE. PROFESSIONAL. <span className="text-[#df5f18]">EFFECTIVE PLATFORM.</span>
                        </h2>
                            ...
                            {steps.map((item, index) => {
                                ...
                                return (
                                    <div key={index} className="border-b border-[#1f1f1f]">
                                        <div className="grid grid-cols-[50px_60px_1fr] items-center py-5 md:grid-cols-[70px_90px_1fr] lg:max-w-4xl">
                                            {/* Icon */}
                                            <div className="flex justify-center">
                                                <div className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-500 md:h-14 md:w-14">
                                                    <Icon className="h-5 w-5 text-[#ff6100] md:h-8 md:w-8" />
                                            ...
                                            {/* Content */}
                                            <div className="border-l-4 border-[#1f1f1f] pl-3 md:pl-5">
                                                <h3 className="mb-1 text-base font-extrabold uppercase sm:text-lg md:text-xl lg:text-2xl">
                                                    {item.title}
                                                </h3>
                        ...
                        {/* Bottom CTA */}
                        <div className="flex items-center gap-4 border-b border-[#1f1f1f] py-6 sm:grid sm:grid-cols-[70px_1fr_200px] md:grid-cols-[90px_1fr_300px] lg:grid-cols-[110px_1fr_320px]">
                            {/* Left Icon */}
                            <div className="flex justify-center">
                                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#e63e00] md:h-20 md:w-20">
                                    <Users className="text-white md:h-12 md:w-12" />
                                </div>
                            </div>
                            {/* Text */}
                            <div>
                                <h3 className="text-base leading-tight font-bold sm:text-lg md:text-xl lg:text-2xl">
                                    Not part of the <span className="text-[#ff6100]">HiLights Football</span>
                                    <br />
                                    community yet?
                                </h3>
                                <p className="mt-3 max-w-xl text-xs leading-relaxed text-[#efefef] sm:text-sm md:text-base">
                                    Create your free profile, share your best moments and become visible to coaches, clubs and recruiters worldwide.
                                </p>
                            </div>
                            {/* Button */}
                            <div className="flex items-end justify-end lg:pr-4">
                                <button className="flex cursor-pointer items-center gap-2 rounded-xl border border-[#773a0c] px-4 py-2 transition hover:bg-[#ff6b00]/10 md:gap-4 lg:px-8 lg:py-4">
                                    <UserPlus className="h-6 w-6 shrink-0 text-white md:h-8 md:w-8" />
                                    <span className="text-left text-xs font-bold uppercase sm:text-sm lg:text-base">
                                        <span className="text-[#dc7936]">Create a Free</span>
                                        <br />
                                        Profile Now
                                    </span>
                ...
                <section className="mx-auto mb-6 max-w-7xl overflow-x-hidden px-4 lg:px-13">
                    <div className="rounded-xl bg-[#f9f9f9] p-3 md:p-6">
                        ...
                        <div className="flex items-center justify-between pb-3">
                            <div className="flex items-center gap-2">
                                <Star size={18} fill="#ff6b00" className="text-[#f25704]" />
                                <h2 className="text-xs font-extrabold whitespace-nowrap text-[#222] uppercase md:text-sm lg:text-base">
                                    Community Highlights
                                </h2>
                            </div>
                            <button className="flex cursor-pointer items-center gap-2 rounded-[10px] bg-white px-4 py-2 text-[10px] font-bold whitespace-nowrap text-gray-700 uppercase shadow-[0_4px_20px_rgba(0,0,0,0.08)] md:text-xs lg:text-sm">
                                View All
                                <ArrowRight size={14} className="text-[#ff6b00]" />
                            </button>
                        </div>
                        ...
                        {players.map((player, index) => (
                            <Link key={index} href={route('profile.public.detail', 1)}>
                                <div className="mb-2 grid grid-cols-[40px_1fr_70px_70px] items-center rounded-[12px] bg-white pr-4 shadow-[0_4px_20px_rgba(0,0,0,0.08)] sm:grid-cols-[70px_1fr_80px_120px] md:grid-cols-[150px_1fr_120px_170px]">
                                    {/* Thumbnail */}
                                    <div className="relative">
                                        <img
                                            src={player.image}
                                    ...
                                    {/* Info */}
                                    <div className="mr-2 px-1 md:px-6">
                                        <h3 className="text-sm font-bold whitespace-nowrap text-[#222] md:text-[15px] lg:text-base">{player.name}</h3>
                                        <p className="text-xs whitespace-nowrap text-gray-600 md:text-sm">{player.position}</p>
                                        <div className="mt-1 flex items-center gap-2">
                                            <span className="text-sm">
                                                <ReactCountryFlag countryCode={player.code} svg className="mt-[2px] mr-1 md:mt-1" />
                                            </span>
                                            <span className="text-xs whitespace-nowrap text-gray-700 md:text-sm">{player.country}</span>
                                        </div>
                                    </div>
                                    {/* Height */}
                                    <div className="mr-3 flex items-center justify-center gap-2 text-xs whitespace-nowrap text-[#222] md:text-sm lg:text-base">
                                        <Ruler size={14} />
                                        <p>{player.height}</p>
                                    </div>
                                    {/* Age */}
                                    <div className="flex items-center justify-end gap-2 text-xs whitespace-nowrap text-[#222] md:ml-4 md:text-sm lg:text-base">
                                        <Clock3 size={14} />
                                        {player.age}
                                    </div>
                                </div>
