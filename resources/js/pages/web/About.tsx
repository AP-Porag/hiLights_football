    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#0D0D0D] font-sans">
            ...
            <main className="pt-16">
                                ...
                                return (
                                    ...
                                    >
                                        <div className="shrink-0 w-12 h-12 rounded-xl bg-[#FFF3EB] dark:bg-[rgba(255,107,0,0.12)] flex items-center justify-center">
                                            <Icon className="w-6 h-6 text-[#E53F01]" strokeWidth={2} />
                                        </div>
                                        <div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {visionCards.map((card) => {
                                ...
                                return (
                                    <div
                                        key={card.title}
                                        className="bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-8 border-t-4 border-t-[#E53F01]"
                                    >
                ...
                <section className="bg-white dark:bg-[#0D0D0D] py-16 lg:py-20 px-6">
                    <div className="max-w-[1100px] mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {/* For Players */}
                            <div className="bg-[#FFF3EB] dark:bg-[rgba(255,107,0,0.08)] border-2 border-[#E53F01] rounded-2xl p-8 lg:p-10">
                                <div className="flex items-center gap-3 mb-2">
                                    <div className="w-10 h-10 rounded-lg bg-[#E53F01] flex items-center justify-center">
                                        <Users className="w-5 h-5 text-white" strokeWidth={2.5} />
                                    </div>
                                    <div className="text-[##E53F01] dark:text-[##E53F01] text-xs tracking-[0.2em] uppercase font-bold">
                                        For Players
                                    </div>
                                </div>
                                ...
                                <ul className="space-y-3.5">
                                    {playerBenefits.map((benefit) => (
                                        <li key={benefit} className="flex gap-3 items-start">
                                            <CheckCircle2
                                                className="w-5 h-5 text-[#E53F01] shrink-0 mt-0.5"
                                                strokeWidth={2}
                                            />
                                ...
                                <Link
                                    href="/register"
                                    className="inline-flex items-center gap-2 mt-8 px-6 py-3 bg-[#E53F01] text-white font-semibold text-sm rounded-lg hover:bg-[#E53F01] transition-colors"
                                >
                ...
                {/* CTA BAND */}
                <section className="bg-[#E53F01] py-16 lg:py-20 px-6 text-center">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                            <Link
                                href="/register"
                                className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-white text-[#E53F01] font-bold text-sm rounded-lg hover:bg-white/90 transition-colors"
                            >
                                Get Started Free
                                <ArrowRight className="w-4 h-4" />
                            </Link>
