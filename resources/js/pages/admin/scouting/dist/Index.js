                ...
                React.createElement(card_1.Card, { className: "border-[#E2E8F0] bg-white" },
                    React.createElement(card_1.CardContent, { className: "p-6" },
                        React.createElement("div", { className: "flex items-start justify-between" },
                            ...
                            React.createElement("div", { className: "flex h-11 w-11 items-center justify-center rounded-lg bg-[#FFF3EB]" },
                                React.createElement(lucide_react_1.Users, { className: "h-5 w-5 text-[#E53F01]" }))))),
                React.createElement(card_1.Card, { className: "border-[#E2E8F0] bg-white" },
                    React.createElement(card_1.CardContent, { className: "p-6" },
                        React.createElement("div", { className: "flex items-start justify-between" },
                            React.createElement("div", { className: "flex-1" },
                                ...
                                React.createElement("div", { className: "mt-3 inline-flex items-center gap-1.5 rounded-md bg-[#FFF3EB] px-2 py-1" },
                                    React.createElement(lucide_react_1.Award, { className: "h-3 w-3 text-[#E53F01]" }),
                                    React.createElement("span", { className: "font-mono text-xs font-semibold text-[#E53F01]" }, summary.topScout.count),
                                    React.createElement("span", { className: "text-xs text-[#E53F01]" }, "ratings submitted"))))))),
            React.createElement(card_1.Card, { className: "border-[#E2E8F0] bg-white" },
                    ...
                    React.createElement("div", { className: "flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between" },
                        ...
                        React.createElement("div", { className: "flex flex-col gap-2 sm:flex-row sm:items-center" },
                            React.createElement("div", { className: "relative" },
                                ...
                                React.createElement(input_1.Input, { placeholder: "Search scout or player...", value: search, onChange: function (e) { return setSearch(e.target.value); }, className: "w-full border-[#E2E8F0] bg-white pl-9 text-sm text-[#0F172A] placeholder:text-[#94A3B8] focus-visible:border-[#E53F01] focus-visible:ring-2 focus-visible:ring-orange-100 sm:w-72" })),
                            ...
                            React.createElement(table_1.TableBody, null, filtered.map(function (rating) { return (React.createElement(table_1.TableRow, { key: rating.id, className: "border-[#E2E8F0] hover:bg-[#F8FAFC]" },
                                    ...
                                    React.createElement("div", { className: "flex items-center gap-3" },
                                        ...
                                        React.createElement("div", null,
                                            React.createElement("div", { className: "flex items-center gap-2" },
                                                ...
                                                React.createElement("span", { className: "rounded border border-[#E53F01] bg-[#FFF3EB] px-1.5 py-0.5 font-mono text-[10px] font-semibold text-[#E53F01]" }, rating.player.position)),
                                ...
                                React.createElement(table_1.TableCell, { className: "py-4" },
                                    React.createElement("div", { className: "inline-flex items-center gap-1.5 rounded-md bg-[#FFF3EB] px-2 py-1" },
                                        ...
                                        React.createElement("span", { className: "font-mono text-sm font-semibold text-[#E53F01]" }, rating.overall.toFixed(1)))),
                                React.createElement(table_1.TableCell, { className: "py-4" },
                                ...
                                React.createElement(table_1.TableCell, { className: "px-6 py-4 text-right" },
                                    React.createElement("div", { className: "flex items-center justify-end gap-1" },
                                        React.createElement(button_1.Button, { variant: "ghost", size: "sm", onClick: function () { return setViewRating(rating); }, className: "h-8 w-8 p-0 text-[#475569] hover:bg-[#FFF3EB] hover:text-[#E53F01]" },
                    ...
                    React.createElement("div", { className: "flex flex-col items-start gap-3 border-t border-[#E2E8F0] p-6 sm:flex-row sm:items-center sm:justify-between" },
                        ...
                        React.createElement("div", { className: "flex items-center gap-2" },
                            ...
                            React.createElement("div", { className: "flex items-center gap-1" },
                                React.createElement(button_1.Button, { size: "sm", className: "h-8 w-8 bg-[#E53F01] p-0 font-mono text-white hover:bg-[#E53F01]" }, "1"),
                        ...
                        React.createElement("div", { className: "divide-y divide-[#E2E8F0]" }, mostRatedPlayers.map(function (player, idx) { return (React.createElement(react_2.Link, { key: player.id, href: "/admin/players/" + player.id, className: "flex items-center gap-4 p-4 transition hover:bg-[#F8FAFC]" },
                            ...
                            React.createElement("div", { className: "min-w-0 flex-1" },
                                React.createElement("div", { className: "flex items-center gap-2" },
                                    ...
                                    React.createElement("span", { className: "rounded border border-[#E53F01] bg-[#FFF3EB] px-1.5 py-0.5 font-mono text-[10px] font-semibold text-[#E53F01]" }, player.position)),
        ...
        React.createElement(dialog_1.Dialog, { open: !!viewRating, onOpenChange: function () { return setViewRating(null); } },
            React.createElement(dialog_1.DialogContent, { className: "max-w-3xl border-[#E2E8F0] bg-white" }, viewRating && (React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: "space-y-5" },
                            ...
                            React.createElement("div", { className: "flex items-center gap-3" },
                                ...
                                React.createElement("div", { className: "min-w-0 flex-1" },
                                    React.createElement("div", { className: "flex items-center gap-2" },
                                        ...
                                        React.createElement("span", { className: "rounded border border-[#E53F01] bg-[#FFF3EB] px-1.5 py-0.5 font-mono text-[10px] font-semibold text-[#E53F01]" }, viewRating.player.position)),
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("div", { className: "grid grid-cols-2 gap-3 md:grid-cols-4" },
                            ...
                            React.createElement("div", { className: "rounded-lg border border-[#E53F01] bg-[#FFF3EB] p-4" },
                                React.createElement("div", { className: "text-xs font-medium uppercase tracking-wider text-[#E53F01]" }, "Overall"),
                                React.createElement("div", { className: "mt-2 flex items-center gap-1" }, Array.from({ length: 5 }).map(function (_, i) { return (React.createElement(lucide_react_1.Star, { key: i, className: "w-5 h-5 " + (i < Math.round(viewRating.overall)
                                        ? 'fill-[#E53F01] text-[#E53F01]'
                                        : 'fill-transparent text-[#E53F01]/30') })); })),
                                React.createElement("div", { className: "mt-2 font-mono text-2xl font-bold text-[#E53F01]" }, viewRating.overall.toFixed(1))))),
                    React.createElement("div", { className: "rounded-lg border border-[#E2E8F0] bg-[#F8FAFC] p-4" },
                        React.createElement("div", { className: "flex items-center gap-2" },
                            React.createElement(lucide_react_1.Calendar, { className: "h-4 w-4 text-[#E53F01]" }),
                ...
                React.createElement(dialog_1.DialogFooter, { className: "gap-2" },
                    ...
                    React.createElement(react_2.Link, { href: "/admin/players/" + viewRating.player.id, className: "inline-flex items-center justify-center rounded-md bg-[#E53F01] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#E53F01]" }, "View Player Profile")))))),
                ...
                React.createElement("div", { className: "rounded-lg border border-[#E2E8F0] bg-[#F8FAFC] p-4" },
                    React.createElement("div", { className: "flex items-center gap-3" },
                        ...
                        React.createElement("div", { className: "inline-flex items-center gap-1 rounded-md bg-[#FFF3EB] px-2 py-1" },
                            React.createElement(lucide_react_1.Star, { className: "h-3 w-3 fill-[#E53F01] text-[#E53F01]" }),
                            React.createElement("span", { className: "font-mono text-sm font-semibold text-[#E53F01]" }, deleteRating.overall.toFixed(1))))),
                React.createElement(dialog_1.DialogFooter, { className: "gap-2" },
