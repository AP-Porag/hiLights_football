                ...
                React.createElement("div", { className: "mx-auto mb-16" },
                    React.createElement("div", { className: "w-[300px] sm:w-[420px] border-1 border-gray-600 rounded-[16px]" },
                        ...
                        React.createElement("div", { className: "flex justify-between items-center relative w-full -mt-2  border-t-1 border-gray-600 p-3 sm:p-6 bg-[url('/images/img/layer.png')] bg-cover bg-center bg-no-repeat rounded-bl-[16px] rounded-br-[16px]" },
                            React.createElement("p", { className: " flex justify-between items-center text-[9px] -ml-3 text-gray-300" },
                            ...
                            React.createElement("div", { className: "absolute -bottom-10 left-0 flex justify-between w-full" },
                                React.createElement("button", { className: "capitalize flex items-center rounded-xl bg-[#e75502] px-1.5 py-1.5 sm:px-2 sm:py-2 font-bold text-white text-[16px] sm:text-[10px] transition-all hover:bg-[#ff7a1a]" },
                                    React.createElement(lucide_react_1.Share2, { className: "mr-2 w-[10px] h-[10px] sm:w-[12px] sm:h-[12px]" }),
                                    "share full profile"),
                                React.createElement("button", { className: "capitalize flex items-center rounded-xl bg-black px-1.5 py-1.5 sm:px-2 sm:py-2 font-bold border-1  text-white text-[16px] sm:text-[10px] transition-all" },
