                        ...
                        React.createElement("div", { className: "overflow-hidden text-white" },
                            React.createElement("div", { className: "flex items-center justify-between" },
                                React.createElement("div", { className: "pl-3 sm:pl-4" },
                                    React.createElement("img", { src: "/images/img/new_logo.png", alt: "new-logo", className: "w-[95px] sm:w-[130px]" })),
                            ...
                            React.createElement("div", { className: "relative flex gap-2 sm:gap-4 pl-4 pt-2 border-b-1 border-gray-400" },
                                ...
                                React.createElement("div", null,
                                    React.createElement("div", { className: "relative z-10" },
                                        ...
                                        React.createElement("p", { className: "text-[8px] sm:text-[10px] text-orange-500 uppercase" }, "ATTACKING MIDFIELDER"),
                                    ...
                                    React.createElement("div", { className: "mt-6 space-y-1" },
                                        React.createElement("div", { className: "flex items-center" },
                                            React.createElement(lucide_react_1.User, { className: "mr-[5px] sm:mr-[10px] w-4 h-4 sm:w-5 sm:h-5 text-orange-500" }),
                                            React.createElement("p", { className: "z-10 text-[8px] md:text-[10px] text-gray-400 uppercase" },
                                                "ID:",
                                                React.createElement("br", null),
                                                React.createElement("span", { className: "text-white" }, "HLF-00012345"))),
                                        React.createElement("div", { className: "flex items-center" },
                                            React.createElement(lucide_react_1.CalendarDays, { className: "mr-[5px] sm:mr-[10px] w-4 h-4 sm:w-5 sm:h-5 text-orange-500" }),
                                            React.createElement("p", { className: "z-10 text-[8px] md:text-[10px] text-gray-400 uppercase" },
                                                "DATE OF BIRTH:",
                                                React.createElement("br", null),
                                                React.createElement("span", { className: "text-white" }, "15 / 05 / 2006"))),
                                        React.createElement("div", { className: "flex items-center" },
                                            React.createElement(lucide_react_1.Flag, { className: "mr-[5px] sm:mr-[10px] w-4 h-4 sm:w-5 sm:h-5 text-orange-500" }),
                                            React.createElement("p", { className: "z-10 text-[8px] md:text-[10px] text-gray-400 uppercase" },
                                                "NATIONALITY:",
                                                React.createElement("br", null),
                                                React.createElement("span", { className: "text-white" }, "Brazil"))),
                                        React.createElement("div", { className: "flex items-center" },
                                            React.createElement(lucide_react_1.MapPin, { className: "mr-[5px] sm:mr-[10px] w-4 h-4 sm:w-5 sm:h-5 text-orange-500" }),
                                            React.createElement("p", { className: "z-10 text-[8px] md:text-[10px] text-gray-400 uppercase" },
                                                "CITY:",
                                                React.createElement("br", null),
                            ...
                            React.createElement("div", { className: "grid gap-3 sm:gap-6 grid-cols-2" },
                                ...
                                React.createElement("div", { className: "pl-4 sm:pl-3" },
                                    ...
                                    React.createElement("button", { className: "mt-2 flex items-center rounded-xl bg-[#ff6600] px-1.5 py-1.5 sm:px-2 sm:py-2 font-bold text-black uppercase transition-all hover:bg-[#ff7a1a]" },
                                        React.createElement("span", { className: "text-[10px] sm:text-[14px]" }, "\uD83D\uDCF1"),
                                        React.createElement("span", { className: "text-left text-[6px] sm:text-[8px] leading-tight" },
                                            "VIEW FULL PROFILE, VIDEOS,",
                                            React.createElement("br", null),
                                            "STATS AND ACHIEVEMENTS"))))),
                        React.createElement("div", { className: "flex justify-between items-center relative w-full border-t-1 border-gray-600 p-3 sm:p-6 bg-[url('/images/img/leyer.png')] bg-cover bg-center bg-no-repeat rounded-bl-[16px] rounded-br-[16px]" },
                            React.createElement("p", { className: " flex justify-between items-center text-[8px] text-gray-300" },
                                React.createElement(lucide_react_1.Shield, { className: "w-3 h-3 sm:w-4 sm:h-4 mr-2" }),
                                "THIS CARD IDENTIFIES THE HOLDER AS AN OFFICIAL",
                                React.createElement("br", null),
                                "MEMBER OF HILIGHTS FOOTBALL PLATFORM."),
                            React.createElement("p", { className: "text-[6px] sm:text-[8px] text-black font-bold translate-x-0 sm:translate-x-[10%]" }, " WWW.HILIGHTSFOOTBALL.COM "),
                            React.createElement("div", { className: "absolute -bottom-10 left-0 flex justify-between w-full" },
                                React.createElement("button", { className: "flex items-center rounded-xl bg-[#ff6600] px-1.5 py-1.5 sm:px-2 sm:py-2 font-bold text-black text-[8px] sm:text-[10px] transition-all hover:bg-[#ff7a1a]" },
                                    React.createElement(lucide_react_1.Share2, { className: "mr-2 w-[10px] h-[10px] sm:w-[12px] sm:h-[12px]" }),
                                    "share full profile"),
                                React.createElement("button", { className: "flex items-center rounded-xl bg-[#black] px-1.5 py-1.5 sm:px-2 sm:py-2 font-bold border-1 border-gray-300 text-white text-[8px] sm:text-[10px] transition-all" },
