...
function PlayerDashboard() {
    ...
    return (React.createElement("div", { className: "min-h-screen bg-[#F8FAFC] pt-16 dark:bg-[#0D0D0D]" },
        ...
        React.createElement("main", { className: "mx-auto max-w-[1300px] space-y-6 px-4 py-6 sm:px-8 sm:py-8" },
            React.createElement("section", { className: "grid grid-cols-1 gap-4 md:grid-cols-2" },
                ...
                React.createElement("div", { className: "w-[420px] border-1 border-gray-600 rounded-[16px] md:translate-x-[20%]" },
                    React.createElement("div", { className: "overflow-hidden text-white" },
                        React.createElement("div", { className: "flex items-center justify-between" },
                            ...
                            React.createElement("div", { className: "-translate-x-[30%] translate-y-[20%]" },
                                React.createElement("h2", { className: "text-center font-bold uppercase text-[14px]" }, "MEMBER CARD"),
                        ...
                        React.createElement("div", { className: "relative flex gap-4 pl-4 pt-2 border-b-1 border-gray-400" },
                            React.createElement("div", { className: "h-[210px] w-[130px] mb-3" },
                            ...
                            React.createElement("div", null,
                                React.createElement("div", { className: "relative z-10" },
                                    ...
                                    React.createElement("div", { className: "absolute mt-2 h-[1px] bg-orange-500 w-[110%]" })),
                    ...
                    React.createElement("div", { className: "bg-[#191917] p-6 text-white" },
                        React.createElement("div", { className: "grid gap-6 grid-cols-2" },
                            React.createElement("div", { className: "relative" },
                                React.createElement("div", { className: "absolute top-0 -right-4 w-[1px] h-full border-r border-white/10" }),
                                React.createElement("h2", { className: "mb-2 text-[10px] font-bold text-[#ff6600] uppercase" }, "Player Info"),
                                React.createElement("div", { className: "space-y-2" }, playerInfo.map(function (item, index) { return (React.createElement("div", { key: index, className: "flex items-center justify-between border-b border-white/10 pb-4" },
                                    React.createElement("div", { className: "flex items-center gap-2" },
                                        React.createElement("span", { className: "" }, item.icon),
                                        React.createElement("span", { className: "text-[8px] pr-2 text-gray-400 uppercase" }, item.label)),
                                    React.createElement("span", { className: "text-[8px] font-medium text-white uppercase" }, item.value))); }))),
                            React.createElement("div", { className: "pl-3" },
                                ...
                                React.createElement("p", { className: "mt-1 mb-6 text-[8px] text-gray-300 uppercase" }, "Open Your Camera And Scan"),
                                ...
                                React.createElement("button", { className: "mt-2 flex items-center rounded-xl bg-[#ff6600] px-2 py-2 font-bold text-black uppercase transition-all hover:bg-[#ff7a1a]" },
                                    React.createElement("span", { className: "text-[14px]" }, "\uD83D\uDCF1"),
                                    React.createElement("span", { className: "text-left text-[8px] leading-tight" },
                                        "VIEW FULL PROFILE, VIDEOS,",
                                        React.createElement("br", null),
                                        "STATS AND ACHIEVEMENTS"))))),
                    React.createElement("div", { className: "flex justify-between items-center w-full border-t-1 border-gray-600 p-6 bg-[url('/images/img/leyer.png')] bg-cover bg-center bg-no-repeat rounded-bl-[16px] rounded-br-[16px]" },
                        React.createElement("p", { className: " flex justify-between items-center text-[8px] text-gray-300" },
                        ...
                        React.createElement("p", { className: "text-[8px] text-black font-bold translate-x-[10%]" }, " WWW.HILIGHTSFOOTBALL.COM ")))),
