...
var Scout = function () {
    ...
    return (react_1["default"].createElement("div", { className: " bg-white text-[#0F172A] dark:bg-[#0D0D0D] dark:text-[#F5F5F5]" },
        ...
        react_1["default"].createElement("main", { className: "pt-16" },
            react_1["default"].createElement("section", { className: "relative w-full h-[100vh] bg-black text-white overflow-hidden", style: {
                            ...
                            react_1["default"].createElement("div", { className: "max-w-xl" },
                                ...
                                react_1["default"].createElement("div", { className: "relative" },
                                    ...
                                    react_1["default"].createElement("div", { className: "flex absolute top-17 md:top-22 lg:top-25 left-0 z-0 flex-row gap-4 w-[200%]" },
                                        react_1["default"].createElement("button", { className: "flex justify-center items-center bg-orange-500 hover:bg-[#E53F01] transition-all duration-300 px-3 py-2 md:px-6 md:py-4 rounded-md font-semibold uppercase text-[10px] md:text-sm" },
                                            ...
                                            react_1["default"].createElement("span", { className: "pl-2" },
                                                ...
                                                " Profile Now")),
                                        react_1["default"].createElement("button", { className: "border flex justify-center items-center bg-black border-gray-600 hover:border-white transition-all duration-300 px-3 py-2 md:px-6 md:py-4 rounded-md font-semibold uppercase text-[10px] md:text-sm" },
            ...
            react_1["default"].createElement("section", { className: "max-w-7xl mx-auto bg-black text-white px-6 sm:px-10 lg:px-16 pt-2" },
                ...
                react_1["default"].createElement("div", { className: "" },
                            ...
                            react_1["default"].createElement("div", { key: index, className: "lg:max-w-4xl grid grid-cols-[50px_1fr] md:grid-cols-[70px_1fr] items-center py-5" },
                                react_1["default"].createElement("div", { className: "flex justify-center" },
                                    react_1["default"].createElement("div", { className: "flex h-9 w-9 md:h-14 md:w-14 items-center justify-center rounded-full border border-gray-500" },
                                        react_1["default"].createElement(Icon, { className: "text-[#E53F01] w-4 h-4 md:w-6 md:h-6" }))),
                                react_1["default"].createElement("div", { className: " border-[#1f1f1f] pl-3 md:pl-5" },
                                    react_1["default"].createElement("h3", { className: "mb-1 text-[#E53F01] text-[14px] sm:text-[16px] md:text-[18px] lg:text-[22px] font-extrabold uppercase" }, item.title),
                    ...
                    react_1["default"].createElement("div", { className: "flex gap-4 sm:grid sm:grid-cols-[70px_1fr_200px] md:grid-cols-[90px_1fr_250px] lg:grid-cols-[110px_1fr_350px] items-center border-b border-[#1f1f1f] py-6" },
                        react_1["default"].createElement("div", { className: "flex justify-center" },
                            react_1["default"].createElement("div", { className: "flex h-12 w-12 md:h-20 md:w-20 items-center justify-center rounded-full bg-[#E53F01]" },
                        ...
                        react_1["default"].createElement("div", { className: "flex justify-end items-end lg:pr-10" },
                            react_1["default"].createElement("button", { className: "flex items-center gap-2 md:gap-4 rounded-xl sm:-w-45 border border-[#E53F01] px-4 py-2 lg:px-8 lg:py-6 transition hover:bg-[#E53F01]/10" },
                ...
                react_1["default"].createElement("div", { className: "w-[90%] mx-auto rounded-xl p-3 md:p-6 bg-[#f9f9f9]" },
                    react_1["default"].createElement("div", { className: "flex items-center justify-between pb-3" },
                        react_1["default"].createElement("div", { className: "flex items-center gap-2 " },
                            react_1["default"].createElement(lucide_react_1.Star, { size: 18, fill: "#E53F01", className: "text-[#E53F01]" }),
                        ...
                        react_1["default"].createElement("button", { className: "flex items-center gap-2 whitespace-nowrap text-[10px] md:text-xs font-bold uppercase text-gray-700 bg-white px-4 py-2 rounded-[10px] shadow-[0_4px_20px_rgba(0,0,0,0.06)]" },
                            "View All",
                            react_1["default"].createElement(lucide_react_1.ArrowRight, { size: 14, className: "text-[#E53F01]" }))),
                    react_1["default"].createElement("div", { className: "flex justify-between items-center overflow-x-auto pb-4" }, players.map(function (player, index) { return (react_1["default"].createElement("div", { key: index, className: "shadow-[0_4px_12px_rgba(0,0,0,0.10)] rounded-[8px] w-[24%]" },
                        react_1["default"].createElement("div", { className: "relative " },
