    ...
    return (react_1["default"].createElement("div", { className: "min-h-screen bg-[#F8FAFC] dark:bg-[#0D0D0D] pt-16 pb-32" },
            ...
            react_1["default"].createElement("div", { className: "max-w-[720px] mx-auto" },
                react_1["default"].createElement("div", { className: "flex items-center" }, STEPS.map(function (s, idx) {
                    ...
                    return (react_1["default"].createElement(react_1["default"].Fragment, { key: s.id },
                        react_1["default"].createElement("button", { onClick: function () { return setStep(idx); }, className: "flex-shrink-0 focus:outline-none", type: "button" }, completed || active ? (react_1["default"].createElement("div", { className: "w-7 h-7 bg-[#E53F01] text-white rounded-full flex items-center justify-center text-xs font-bold font-sans" }, completed ? react_1["default"].createElement(lucide_react_1.CheckCircle2, { className: "w-4 h-4" }) : idx + 1)) : (react_1["default"].createElement("div", { className: "w-7 h-7 border-2 border-[#E2E8F0] dark:border-[#2A2A2A] text-[#94A3B8] rounded-full flex items-center justify-center text-xs font-bold font-sans" }, idx + 1))),
                        idx < STEPS.length - 1 && (react_1["default"].createElement("div", { className: "flex-1 h-0.5 mx-1 sm:mx-2 " + (idx < step ? 'bg-[#E53F01]' : 'bg-[#E2E8F0] dark:bg-[#2A2A2A]') }))));
                })),
                react_1["default"].createElement("div", { className: "hidden sm:flex items-center justify-between mt-3" }, STEPS.map(function (s, idx) { return (react_1["default"].createElement("div", { key: s.id, className: "text-[10px] uppercase tracking-widest font-semibold font-sans " + (idx === step ? 'text-[#E53F01]' : 'text-[#94A3B8]'), style: { width: 100 / STEPS.length + "%", textAlign: idx === 0 ? 'left' : idx === STEPS.length - 1 ? 'right' : 'center' } }, s.label)); })),
                react_1["default"].createElement("div", { className: "sm:hidden mt-3 text-center" },
                    react_1["default"].createElement("div", { className: "text-[10px] uppercase tracking-widest font-semibold font-sans text-[#E53F01]" },
                        "Step ",
                        step + 1,
                        " of ",
                        STEPS.length,
        ...
        react_1["default"].createElement("div", { className: "max-w-[720px] mx-auto px-4 py-8" },
            step === 0 && (react_1["default"].createElement("section", null,
                react_1["default"].createElement("div", { className: "text-[#E53F01] text-[10px] font-bold tracking-[0.14em] uppercase mb-4 font-sans" }, "01 / Basic Information"),
                    ...
                    react_1["default"].createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-5" },
                        react_1["default"].createElement("div", null,
                            react_1["default"].createElement(label_1.Label, { htmlFor: "full_name", className: "text-xs font-semibold text-[#0F172A] dark:text-[#F5F5F5] mb-2 block font-sans" },
                                "Full Name ",
                                react_1["default"].createElement("span", { className: "text-[#E53F01]" }, "*")),
                            react_1["default"].createElement(input_1.Input, { id: "full_name", value: data.full_name, onChange: function (e) { return setData('full_name', e.target.value); }, placeholder: "John Smith", className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01]" })),
                        react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement(input_1.Input, { id: "nickname", value: data.nickname, onChange: function (e) { return setData('nickname', e.target.value); }, placeholder: "Optional", className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01]" })),
                        react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement("div", { className: "flex items-center gap-3" },
                                react_1["default"].createElement(input_1.Input, { id: "dob", type: "date", value: data.dob, onChange: function (e) { return setData('dob', e.target.value); }, className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01] [color-scheme:light] dark:[color-scheme:dark]" }),
                                age !== null && (react_1["default"].createElement("div", { className: "flex-shrink-0 bg-[#FFF3EB] dark:bg-[rgba(255,107,0,0.12)] border border-[#E53F01] text-[#E53F01] rounded-full px-3 py-1 text-xs font-bold font-mono whitespace-nowrap" },
                                    age,
                                    " yrs")))),
                        react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement(radio_group_1.RadioGroup, { value: data.gender, onValueChange: function (v) { return setData('gender', v); }, className: "flex gap-4 h-10 items-center" }, ['M', 'F', 'Other'].map(function (g) { return (react_1["default"].createElement("div", { key: g, className: "flex items-center gap-2" },
                                react_1["default"].createElement(radio_group_1.RadioGroupItem, { value: g, id: "gender-" + g, className: "border-[#CBD5E1] dark:border-[#2A2A2A] text-[#E53F01]" }),
                        ...
                        react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement(input_1.Input, { id: "height", type: "number", value: data.height, onChange: function (e) { return setData('height', e.target.value); }, placeholder: "178", className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] font-mono focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01]" })),
                        react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement(input_1.Input, { id: "birth_city", value: data.birth_city, onChange: function (e) { return setData('birth_city', e.target.value); }, placeholder: "City", className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01]" })),
                        react_1["default"].createElement("div", null,
                        ...
                        react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement(input_1.Input, { id: "current_club", value: data.current_club, onChange: function (e) { return setData('current_club', e.target.value); }, placeholder: "Club name", className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01]" })),
                        react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement(input_1.Input, { id: "in_team_since", type: "month", value: data.in_team_since, onChange: function (e) { return setData('in_team_since', e.target.value); }, className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] font-mono focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01] [color-scheme:light] dark:[color-scheme:dark]" })),
                        react_1["default"].createElement("div", { className: "lg:col-span-2" },
                            ...
                            react_1["default"].createElement(input_1.Input, { id: "agent", value: data.agent, onChange: function (e) { return setData('agent', e.target.value); }, placeholder: "Agent or agency name", className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01]" }))),
                    isMinor && (react_1["default"].createElement("div", { className: "mt-6" },
                        ...
                        react_1["default"].createElement("div", { className: "mt-4" },
                            react_1["default"].createElement(label_1.Label, { htmlFor: "guardian_name", className: "text-xs font-semibold text-[#0F172A] dark:text-[#F5F5F5] mb-2 block font-sans" },
                                "Guardian Name ",
                                react_1["default"].createElement("span", { className: "text-[#E53F01]" }, "*")),
                            react_1["default"].createElement(input_1.Input, { id: "guardian_name", value: data.guardian_name, onChange: function (e) { return setData('guardian_name', e.target.value); }, placeholder: "Parent or legal guardian's full name", className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01]" }))))))),
            step === 1 && (react_1["default"].createElement("section", null,
                react_1["default"].createElement("div", { className: "text-[#E53F01] text-[10px] font-bold tracking-[0.14em] uppercase mb-4 font-sans" }, "02 / Football Details"),
                react_1["default"].createElement("div", { className: "bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-6 sm:p-8" },
                    react_1["default"].createElement("div", { className: "mb-8" },
                        ...
                        react_1["default"].createElement("div", { className: "flex flex-wrap gap-3" }, MODALITIES.map(function (m) {
                            ...
                            return (react_1["default"].createElement("button", { key: m, type: "button", onClick: function () { return setData('modality', m); }, className: "px-5 py-2.5 rounded-full text-sm font-semibold font-sans transition-colors " + (selected
                                    ? 'bg-[#E53F01] text-white border-0'
                                    : 'bg-white dark:bg-[#1F1F1F] border border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] hover:border-[#E53F01]') }, m));
                        }))),
                    react_1["default"].createElement("div", { className: "mb-8" },
                        ...
                        react_1["default"].createElement("div", { className: "md:hidden grid grid-cols-3 gap-3" }, ALL_POSITIONS.map(function (id) {
                            ...
                            return (react_1["default"].createElement("label", { key: id, className: "flex items-center gap-2 px-3 py-2.5 rounded-xl border cursor-pointer transition-colors " + (selected
                                    ? 'bg-[#FFF3EB] dark:bg-[rgba(255,107,0,0.12)] border-[#E53F01]'
                                    : 'bg-white dark:bg-[#1F1F1F] border-[#E2E8F0] dark:border-[#2A2A2A]') },
                                react_1["default"].createElement(checkbox_1.Checkbox, { checked: selected, onCheckedChange: function () { return togglePosition(id); }, className: "border-[#CBD5E1] dark:border-[#2A2A2A] data-[state=checked]:bg-[#E53F01] data-[state=checked]:border-[#E53F01]" }),
                                react_1["default"].createElement("span", { className: "text-xs font-semibold font-sans " + (selected ? 'text-[#E53F01]' : 'text-[#0F172A] dark:text-[#F5F5F5]') }, id)));
                        })),
                        react_1["default"].createElement("div", { className: "mt-4 flex flex-wrap items-center gap-2" },
                            ...
                            data.positions.map(function (id) { return (react_1["default"].createElement("span", { key: id, className: "inline-flex items-center gap-1.5 bg-[#FFF3EB] dark:bg-[rgba(255,107,0,0.12)] border border-[#E53F01] text-[#E53F01] rounded-full px-3 py-1 text-xs font-bold font-mono" },
                                id,
                    ...
                    react_1["default"].createElement("div", null,
                        ...
                        react_1["default"].createElement(radio_group_1.RadioGroup, { value: data.foot, onValueChange: function (v) { return setData('foot', v); }, className: "flex flex-col sm:flex-row gap-4" }, ['Right', 'Left', 'Ambidextrous'].map(function (f) { return (react_1["default"].createElement("div", { key: f, className: "flex items-center gap-2" },
                            react_1["default"].createElement(radio_group_1.RadioGroupItem, { value: f, id: "foot-" + f, className: "border-[#CBD5E1] dark:border-[#2A2A2A] text-[#E53F01]" }),
            ...
            step === 2 && (react_1["default"].createElement("section", null,
                react_1["default"].createElement("div", { className: "text-[#E53F01] text-[10px] font-bold tracking-[0.14em] uppercase mb-4 font-sans" }, "03 / Media"),
                react_1["default"].createElement("div", { className: "bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-6 sm:p-8 space-y-8" },
                    react_1["default"].createElement("div", null,
                        ...
                        data.photo_preview ? (react_1["default"].createElement("div", { className: "flex flex-col sm:flex-row items-center gap-6" },
                            react_1["default"].createElement("img", { src: data.photo_preview, alt: "Preview", className: "w-24 h-24 rounded-full object-cover border-2 border-[#E53F01]" }),
                            ...
                            react_1["default"].createElement("div", { className: "border-2 border-dashed border-[#E2E8F0] dark:border-[#2A2A2A] hover:border-[#E53F01] rounded-2xl p-12 text-center transition-colors" },
                    ...
                    react_1["default"].createElement("div", null,
                        ...
                        react_1["default"].createElement("div", { className: "relative" },
                            react_1["default"].createElement(lucide_react_1.Youtube, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#E53F01] pointer-events-none" }),
                            react_1["default"].createElement(input_1.Input, { id: "video_url", value: data.video_url, onChange: function (e) { return setData('video_url', e.target.value); }, placeholder: "YouTube or Vimeo URL", className: "pl-10 pr-10 bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01]" }),
            ...
            step === 3 && (react_1["default"].createElement("section", null,
                react_1["default"].createElement("div", { className: "text-[#E53F01] text-[10px] font-bold tracking-[0.14em] uppercase mb-4 font-sans" }, "04 / Club History"),
                react_1["default"].createElement("div", { className: "bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-6 sm:p-8" },
                    react_1["default"].createElement("div", { className: "overflow-hidden rounded-xl border border-[#E2E8F0] dark:border-[#2A2A2A]" },
                        react_1["default"].createElement("table", { className: "table-auto w-full" },
                            ...
                            react_1["default"].createElement("tbody", null, data.club_history.map(function (row, idx) { return (react_1["default"].createElement("tr", { key: row.year, className: "border-t border-[#E2E8F0] dark:border-[#2A2A2A]" },
                                ...
                                react_1["default"].createElement("td", { className: "py-2 px-4" },
                                    react_1["default"].createElement(input_1.Input, { value: row.club, onChange: function (e) { return updateClubHistory(idx, e.target.value); }, placeholder: "Club name (optional)", className: "w-full bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01] h-9" })),
            ...
            step === 4 && (react_1["default"].createElement("section", null,
                react_1["default"].createElement("div", { className: "text-[#E53F01] text-[10px] font-bold tracking-[0.14em] uppercase mb-4 font-sans" }, "05 / About You"),
                react_1["default"].createElement("div", { className: "bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-6 sm:p-8" },
                    ...
                    react_1["default"].createElement(textarea_1.Textarea, { id: "description", rows: 5, maxLength: 500, value: data.description, onChange: function (e) { return setData('description', e.target.value); }, placeholder: "Describe your playing style, strengths, and football journey...", className: "bg-white dark:bg-[#111111] border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] focus-visible:ring-2 focus-visible:ring-orange-100 dark:focus-visible:ring-orange-800 focus-visible:border-[#E53F01] resize-none" }),
                    react_1["default"].createElement("div", { className: "flex justify-end mt-2" },
                        react_1["default"].createElement("span", { className: "text-xs font-mono " + (descCount > 450 ? 'text-[#E53F01] font-bold' : 'text-[#94A3B8]') },
                            descCount,
                            " / 500")))))),
        react_1["default"].createElement("div", { className: "bg-white dark:bg-[#0D0D0D] border-t border-[#E2E8F0] dark:border-[#2A2A2A] fixed bottom-0 left-0 right-0 z-20 h-[68px] px-4 sm:px-8 flex items-center justify-between" },
            ...
            react_1["default"].createElement("div", { className: "flex items-center gap-2 sm:gap-3 ml-auto" },
                react_1["default"].createElement(button_1.Button, { type: "button", variant: "ghost", onClick: goBack, disabled: step === 0, className: "text-[#475569] dark:text-[#9A9A9A] hover:text-[#0F172A] dark:hover:text-[#F5F5F5] hover:bg-[#F8FAFC] dark:hover:bg-[#1F1F1F] disabled:opacity-30" },
                    ...
                    "Back"),
                react_1["default"].createElement(button_1.Button, { type: "button", variant: "outline", className: "border-[#E2E8F0] dark:border-[#2A2A2A] text-[#0F172A] dark:text-[#F5F5F5] hover:border-[#E53F01] hover:text-[#E53F01] bg-white dark:bg-[#1F1F1F]" }, "Save Draft"),
                step < STEPS.length - 1 ? (react_1["default"].createElement(button_1.Button, { type: "button", onClick: goNext, className: "bg-[#E53F01] text-white hover:bg-[#E53F01]" },
                    "Next",
                    react_1["default"].createElement(lucide_react_1.ArrowRight, { className: "w-4 h-4 ml-1" }))) : (react_1["default"].createElement(button_1.Button, { type: "button", disabled: processing, className: "bg-[#E53F01] text-white hover:bg-[#E53F01]" },
                    "Save & Publish",
