...
export default function Detail() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#0D0D0D] text-[#0F172A] dark:text-[#F5F5F5] font-sans">
            ...
            {/* ====================== LEADERBOARD AD - TOP ====================== */}
            <div className="w-full bg-[#F8FAFC] dark:bg-[#111111] border-b border-[#E2E8F0] dark:border-[#2A2A2A] py-3">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex justify-center">
                        <div className="relative w-full max-w-[728px] h-[90px] bg-black rounded-2xl overflow-hidden flex items-center justify-between px-6">
                            <span className="absolute top-1 right-2 text-[10px] text-white/40 uppercase tracking-wider">
                                Ad
                            </span>
                            <div className="flex items-center gap-4">
                                ...
                                <div className="hidden sm:block">
                                    <div className="text-[#FF6B00] font-display text-xl font-bold leading-tight">
                                        PHANTOM GX 2
                                    </div>
                                    <div className="text-white/70 text-xs">Just Do It.</div>
                                </div>
                            </div>
                            <button className="bg-[#FF6B00] hover:bg-[#CC5500] text-white px-4 sm:px-6 py-2 rounded-xl font-semibold text-sm transition-colors">
                                Shop Now
                            </button>
                        </div>
                    </div>
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                    <div className="flex flex-col lg:flex-row gap-8 items-start lg:items-end">
                        ...
                        <div className="flex-1 w-full">
                            ...
                            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold uppercase leading-none mb-2">
                                {player.fullName}
                            </h1>
                            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-white/70 mb-4">
                                ...
                                <span className="flex items-center gap-1.5">
                                    <img src={player.clubLogo} alt="" className="w-4 h-4 rounded" />
                                    {player.currentClub}
                                </span>
                            </div>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                                <div className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4">
                                    ...
                                    <div className="font-mono text-xl sm:text-2xl font-bold text-[#FF6B00]">
                                        {player.marketValue}
                                    </div>
                                </div>
                                <div className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4">
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4">
                                    ...
                                    <div className="font-mono text-xl sm:text-2xl font-bold">
                                        {(player.profileViews / 1000).toFixed(1)}K
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <aside className="hidden lg:block lg:col-span-2">
                            <div className="sticky top-24 space-y-6">
                                <div className="relative w-[300px] h-[600px] bg-[#0B1929] rounded-2xl overflow-hidden">
                                    <span className="absolute top-2 left-2 text-[10px] text-white/40 uppercase tracking-wider z-10">
                                        Sponsored
                                    </span>
                                    <div className="absolute inset-0 flex flex-col items-center justify-between p-6 text-white">
                                        <div className="text-center pt-6">
                                            <div className="font-display text-3xl font-black tracking-tight mb-1">
                                                WYSCOUT
                                            </div>
                                        ...
                                        <div className="text-center px-2">
                                            <div className="font-display text-2xl font-bold leading-tight mb-3">
                                                DISCOVER 600,000+ PLAYERS
                                            </div>
                                            <p className="text-sm text-white/70 mb-6">
                                                Advanced video analysis, player databases & opposition reports trusted
                                                by elite clubs worldwide.
                                            </p>
                                            <div className="grid grid-cols-2 gap-2 mb-6 text-left">
                                                <div className="bg-white/5 rounded-lg p-2">
                                                    <div className="text-blue-400 text-[10px] uppercase font-bold">
                                                        Players
                                                    </div>
                                        ...
                                        <button className="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-xl font-semibold text-sm transition-colors">
                                            Request a Demo
                                        </button>
                                    </div>
                                </div>
                        ...
                        <main className="lg:col-span-7 space-y-6">
                            ...
                            {/* SCOUT ACTIONS - ALWAYS VISIBLE */}
                            <div className="bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-6">
                                <div className="flex items-center justify-between mb-5">
                                    <div>
                                        <div className="text-[10px] uppercase tracking-wider text-[#475569] dark:text-[#9A9A9A] font-bold mb-1">
                                            Scout Toolkit
                                        </div>
                                    ...
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-[#FFF3EB] dark:bg-[rgba(255,107,0,0.12)] border border-[#FF6B00] text-[#CC5500] text-[10px] uppercase font-bold tracking-wider">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                                    ...
                                    <Link
                                        href={`/scout/players/${player.slug}/report`}
                                        className="flex flex-col items-center gap-2 p-4 rounded-xl border bg-[#F8FAFC] dark:bg-[#1F1F1F] border-[#E2E8F0] dark:border-[#2A2A2A] hover:border-[#FF6B00] transition-colors"
                                    >
                                        <FileText className="w-5 h-5" />
                                        <span className="text-xs font-semibold">Write Report</span>
                                    </Link>
                                    <Link
                                        href={`/scout/players/${player.slug}/contact`}
                                        className="flex flex-col items-center gap-2 p-4 rounded-xl border bg-[#F8FAFC] dark:bg-[#1F1F1F] border-[#E2E8F0] dark:border-[#2A2A2A] hover:border-[#FF6B00] transition-colors"
                                    >
                                        <Send className="w-5 h-5" />
                                        <span className="text-xs font-semibold">Contact Player</span>
                                    </Link>
                                    <Link
                                        href={`/scout/players/${player.slug}/compare`}
                                        className="flex flex-col items-center gap-2 p-4 rounded-xl border bg-[#F8FAFC] dark:bg-[#1F1F1F] border-[#E2E8F0] dark:border-[#2A2A2A] hover:border-[#FF6B00] transition-colors"
                                    >
                                ...
                                <div className="border-t border-[#E2E8F0] dark:border-[#2A2A2A] pt-6">
                                    <div className="flex items-center justify-between mb-5">
                                        ...
                                        {averageRating > 0 && (
                                            <div className="text-right">
                                                <div className="text-[10px] uppercase tracking-wider text-[#475569] dark:text-[#9A9A9A] font-bold">
                                                    Overall
                                                </div>
                                                <div className="font-mono text-2xl font-bold text-[#FF6B00]">
                                                    ...
                                                    <div className="flex items-center justify-between mb-2">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="text-[11px] text-[#94A3B8] dark:text-[#555555]">
                                                                    {cat.desc}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="font-mono text-lg font-bold text-[#FF6B00] w-10 text-right">
                                                            {value || '—'}
                                                        </div>
                                                    </div>
                                                        ...
                                                        {Array.from({ length: 10 }).map((_, i) => {
                                                            ...
                                                            return (
                                                                <button
                                                                    ...
                                                                    onClick={() =>
                                                                        handleRatingChange(
                                                                            cat.key as keyof Omit<ScoutRating, 'notes'>,
                                                                            score,
                                                                        )
                                                                    }
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 mt-5">
                                        <button className="flex-1 bg-[#FF6B00] hover:bg-[#CC5500] text-white px-6 py-3 rounded-xl font-semibold text-sm transition-colors">
                                            Save Rating
                                        </button>
                                        <button className="flex-1 bg-white dark:bg-[#1F1F1F] border border-[#E2E8F0] dark:border-[#2A2A2A] hover:border-[#FF6B00] text-[#0F172A] dark:text-[#F5F5F5] px-6 py-3 rounded-xl font-semibold text-sm transition-colors">
                                            Save & Add to Report
                                        </button>
                                    </div>
                                </div>
                            ...
                            {/* BIO */}
                            <div className="bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-6">
                                <div className="text-[10px] uppercase tracking-wider text-[#475569] dark:text-[#9A9A9A] font-bold mb-2">
                                    About
                                </div>
                                <h2 className="font-display text-2xl font-bold uppercase mb-3">
                                    Player Profile
                                </h2>
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                    <div>
                                        <div className="text-[10px] uppercase tracking-wider text-[#94A3B8] dark:text-[#555555] mb-1">
                                            Height
                                        </div>
                            ...
                            {/* IN-CONTENT AD (640x100) */}
                            <div className="relative w-full h-[100px] bg-black rounded-2xl overflow-hidden flex items-center justify-between px-6">
                                <span className="absolute top-1 right-2 text-[10px] text-white/40 uppercase tracking-wider">
                                    Ad
                                </span>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="text-white font-display text-xl font-black tracking-tight">
                                            ADIDAS PREDATOR
                                        </div>
                                        <div className="text-white/60 text-xs">Impossible is Nothing.</div>
                                    </div>
                                </div>
                                <button className="bg-white hover:bg-white/90 text-black px-4 sm:px-6 py-2 rounded-xl font-bold text-sm transition-colors">
                                    Discover
                                </button>
                            </div>
                                        ...
                                        {Object.entries(player.attributes).map(([key, value]) => (
                                            <div key={key}>
                                                <div className="flex items-center justify-between mb-1.5">
                                                    <span className="text-xs uppercase tracking-wider font-semibold text-[#475569] dark:text-[#9A9A9A]">
                                                        {key}
                                                    </span>
                            ...
                            <div className="bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-6">
                                <div className="flex items-center justify-between mb-5">
                                    ...
                                    <span className="font-mono text-xs text-[#475569] dark:text-[#9A9A9A]">
                                        {player.highlightCount} videos
                                    </span>
                                </div>
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                    {[
                                        ...
                                        return (
                                            <div
                                                key={stat.label}
                                                className="bg-[#F8FAFC] dark:bg-[#1F1F1F] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-xl p-4"
                                            >
                                                <Icon className="w-4 h-4 text-[#FF6B00] mb-2" />
                                                <div className="font-mono text-2xl font-bold">{stat.value}</div>
                                                <div className="text-[10px] uppercase tracking-wider text-[#475569] dark:text-[#9A9A9A] font-bold mt-1">
                                                    {stat.label}
                                                </div>
                                            </div>
                                        );
                            ...
                            <div className="bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-6">
                                ...
                                <div className="space-y-4">
                                    {careerHistory.map((entry, i) => (
                                        <div
                                            key={i}
                                            className="flex items-start gap-4 pb-4 border-b border-[#E2E8F0] dark:border-[#2A2A2A] last:border-0 last:pb-0"
                                        >
                        ...
                        <aside className="lg:col-span-3 space-y-6">
                            ...
                            <div
                                className={`relative ${
                                    player.isPremium
                                        ? 'bg-[#F0FDF4] dark:bg-[rgba(22,163,74,0.08)] border border-green-200 dark:border-green-800'
                                        : 'bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A]'
                                } rounded-2xl p-6`}
                            >
                                <div className="flex items-center justify-between mb-4">
                                    <div className="text-[10px] uppercase font-bold tracking-wider text-green-700 dark:text-green-400">
                                        Player Contact
                                    </div>
                                    {player.isPremium && (
                                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded bg-green-600 text-white text-[10px] font-bold uppercase tracking-wider">
                                            Unlocked
                                        </span>
                                    )}
                                </div>
                                ...
                                {player.isPremium ? (
                                    <div className="space-y-3">
                                        <a
                                            href="mailto:agent@talentos.com.br"
                                            className="flex items-center gap-3 p-3 bg-white dark:bg-[#161616] border border-green-200 dark:border-green-800 rounded-xl hover:border-green-400 transition-colors"
                                        >
                                        ...
                                        <div className="text-[11px] text-green-700 dark:text-green-400 px-1 pt-1 leading-relaxed">
                                            Direct line to player's agent. Please be professional and verify your
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                                            ...
                                            <p className="text-xs font-semibold text-[#0F172A] dark:text-[#F5F5F5] mb-1">
                                                Player needs Premium to show contact info
                                            </p>
                                            <p className="text-[11px] text-[#475569] dark:text-[#9A9A9A]">
                                                Use the Contact Player button to send a scouting inquiry.
                                            </p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="relative w-full max-w-[300px] mx-auto h-[600px] bg-[#1A0F0A] rounded-2xl overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 flex flex-col p-6 text-white">
                                        <div className="text-center pt-4 mb-6">
                                            <div className="font-display text-3xl font-black italic tracking-tight">
                                                TRANSFER<span className="text-[#FF6B00]">ROOM</span>
                                            </div>
                                        ...
                                        <div className="flex-1 flex flex-col justify-center text-center">
                                            ...
                                            <p className="text-sm text-white/70 mb-6">
                                                The professional network for football's transfer market. Trusted by
                                                decision-makers at the world's biggest clubs.
                                            </p>
                                        ...
                                        <button className="w-full bg-[#FF6B00] hover:bg-[#CC5500] text-white py-3 rounded-xl font-bold text-sm transition-colors">
                                            Join the Network
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div className="relative w-full max-w-[300px] mx-auto h-[250px] bg-[#001E2E] rounded-2xl overflow-hidden">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-between p-5 text-white">
                                    <div className="text-center pt-2">
                                        ...
                                        <div className="text-[10px] uppercase tracking-widest text-blue-300 mt-1">
                                            Data & Analytics
                                        </div>
                                    </div>
                                    <div className="text-center">
                                        <div className="font-display text-lg font-bold leading-tight mb-2">
                                            ELITE FOOTBALL ANALYTICS
                                        </div>
                                        <p className="text-xs text-white/60">
                                            Real-time data powering the world's top scouting departments.
                                        </p>
                                    </div>
                                    <button className="w-full bg-[#0091EA] hover:bg-[#0277BD] text-white py-2.5 rounded-lg font-semibold text-xs transition-colors">
                                        Explore Solutions
                                    </button>
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        {similarPlayers.map((sp) => (
                            <Link
                                key={sp.id}
                                href={`/scout/players/${sp.slug}`}
                                className="group bg-white dark:bg-[#161616] border border-[#E2E8F0] dark:border-[#2A2A2A] rounded-2xl p-6 hover:border-[#FF6B00] transition-colors"
                            >
                                <div className="flex items-start gap-4 mb-4">
                                    <img
                                        src={sp.profileImage}
                                        alt={sp.fullName}
                                        className="w-16 h-16 rounded-xl border-2 border-[#E2E8F0] dark:border-[#2A2A2A] group-hover:border-[#FF6B00] transition-colors object-cover"
                                    />
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <h3 className="font-display text-lg font-bold uppercase leading-tight truncate">
                                            {sp.fullName}
                                        </h3>
                                ...
                                <div className="grid grid-cols-3 gap-2 pt-4 border-t border-[#E2E8F0] dark:border-[#2A2A2A]">
                                    <div>
                                        <div className="text-[9px] uppercase tracking-wider text-[#94A3B8] dark:text-[#555555] font-bold">
                                            Age
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="font-mono text-sm font-bold">
                                            {sp.stats.goals}/{sp.stats.assists}
                                        </div>
                                    </div>
                                    <div>
                                        <div className="text-[9px] uppercase tracking-wider text-[#94A3B8] dark:text-[#555555] font-bold">
                                        ...
                                        <div className="font-mono text-sm font-bold text-[#FF6B00]">
                                            {sp.marketValue}
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6 text-white">
                        <div className="text-center sm:text-left">
                            <h3 className="font-display text-2xl sm:text-3xl font-bold uppercase leading-tight">
                                Build Your Watchlist
                            </h3>
                            <p className="text-sm text-white/90 mt-1">
                                Track players, compare profiles, and export scouting reports.
                            </p>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                            <Link
                                href="/scout/shortlist"
                                className="bg-white hover:bg-white/90 text-[#FF6B00] px-6 py-3 rounded-xl font-bold text-sm text-center transition-colors"
                            >
                                Open My Shortlist
                            </Link>
                            <Link
                                href="/scout/players"
                                className="bg-[#0F172A] hover:bg-[#1F1F1F] text-white px-6 py-3 rounded-xl font-bold text-sm text-center transition-colors"
                            >
                                Browse Players
                            </Link>
                        </div>
            ...
            <footer className="bg-[#0F172A] text-white py-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
                        <div className="col-span-2">
                            <img
                                ...
                                className="h-10 w-auto dark:hidden mb-3"
                                alt="HiLights Football"
                            />
                            <img
                                src="/images/logo/hilights_logo_dark_200.png"
                                className="h-10 w-auto hidden dark:block mb-3"
                                alt="HiLights Football"
                            />
                            <p className="text-sm text-white/60 max-w-sm">
                                The enterprise football scouting platform connecting clubs, agents, and the
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                <li>
                                    <Link href="/scout/players" className="text-white/70 hover:text-white">
                                        Browse Players
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/scout/shortlist" className="text-white/70 hover:text-white">
                                        My Shortlist
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/scout/reports" className="text-white/70 hover:text-white">
                                        Reports
                                    </Link>
                                </li>
                            </ul>
                    ...
                    <div className="pt-6 border-t border-white/10 text-xs text-white/40 text-center sm:text-left">
                        © 2025 HiLights Football. All rights reserved.
                    </div>
                </div>
            </footer>
        </div>
