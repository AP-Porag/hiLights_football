    ...
    return (react_2["default"].createElement("header", { className: [
        ...
        react_2["default"].createElement("div", { className: "mx-auto flex h-full max-w-[1400px] items-center justify-between gap-4 px-2 sm:px-6" },
            react_2["default"].createElement(react_1.Link, { href: "/", className: "flex shrink-0 items-center gap-2", "aria-label": "HiLights Football home" },
                react_2["default"].createElement("img", { src: "/images/logo/final_logo.png", className: "hidden h-6 w-auto sm:h-8 lg:h-10 md:mt-2 lg:mt-3 dark:block", alt: "HiLights Football" })),
