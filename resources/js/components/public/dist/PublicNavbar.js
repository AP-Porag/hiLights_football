...
function PublicNavbar() {
    ...
    return (react_2["default"].createElement("header", { className: [
        ...
        react_2["default"].createElement("div", { className: "mx-auto flex h-full max-w-7xl items-center justify-between gap-4 overflow-hidden px-2 sm:px-4 md:px-6" },
            react_2["default"].createElement(react_1.Link, { href: "/", className: "flex shrink-0 items-center gap-2", "aria-label": "HiLights Football home" },
                react_2["default"].createElement("img", { src: "/images/logo/final_logo.png", className: "h-6 w-auto sm:h-8 lg:h-10 md:mt-2 lg:mt-3 dark:hidden", alt: "HiLights Football" })),
            ...
            react_2["default"].createElement("div", { className: "relative hidden w-56 lg:block" },
                ...
                react_2["default"].createElement(input_1.Input, { type: "search", placeholder: "Search players...", className: "h-9 rounded-lg border border-[#E2E8F0] bg-[#F8FAFC] pr-3 pl-8 text-sm text-[#0F172A] outline-none placeholder:text-[#94A3B8] focus:border-[#FF6B00] focus-visible:ring-2 focus-visible:ring-orange-100 focus-visible:ring-offset-0 dark:border-[#2A2A2A] dark:bg-[#111111] dark:text-[#F5F5F5] dark:focus-visible:ring-[rgba(255,107,0,0.15)]" })),
            react_2["default"].createElement("div", { className: "hidden shrink-0 items-center gap-2 md:flex" },
                react_2["default"].createElement(react_1.Link, { href: "/login" },
                    react_2["default"].createElement(button_1.Button, { variant: "outline", size: "sm", className: "border-[#E2E8F0] cursor-pointer bg-gray-50 text-sm font-medium text-[#0F172A] hover:border-[#FF6B00] hover:bg-transparent hover:text-[#FF6B00] dark:border-[#2A2A2A] dark:text-[#F5F5F5] dark:hover:bg-transparent" }, "Login")),
                react_2["default"].createElement(react_1.Link, { href: "/register" },
                    react_2["default"].createElement(button_1.Button, { size: "sm", className: "bg-[#e53f01] px-4 text-sm cursor-pointer font-semibold text-white hover:bg-[#ff5e24]" }, "Create A Free Profile Now"))),
            react_2["default"].createElement("div", { className: "flex items-center gap-1 md:hidden" },
                react_2["default"].createElement("div", { className: "flex items-center gap-0.5" }, NAV_LINKS_MOBILE.map(function (link) {
                    var active = isActive(link.href);
                    return (react_2["default"].createElement(react_1.Link, { key: link.href, href: link.href, className: "flex w-7 sm:w-12 flex-col items-center justify-center" },
                        ...
                        react_2["default"].createElement("span", { className: [' text-[8px] sm:text-[12px] font-medium whitespace-nowrap', active ? 'text-[#FF6B00]' : 'text-white'].join(' ') }, link.label)));
                })),
                react_2["default"].createElement(react_1.Link, { href: "/register" },
                    react_2["default"].createElement(button_1.Button, { className: "h-9 sm:h-11 rounded-md bg-[#FF6B00] px-2 sm:px-4 text-[8px] sm:text-[11px] leading-tight font-bold text-white uppercase hover:bg-[#e65c00]" },
                        "Create A Free",
                ...
                react_2["default"].createElement(sheet_1.Sheet, { open: mobileOpen, onOpenChange: setMobileOpen },
                    react_2["default"].createElement(sheet_1.SheetTrigger, { asChild: true },
                        react_2["default"].createElement(button_1.Button, { variant: "secondary", size: "icon", "aria-label": "Open menu", className: "h-7 w-7 sm:h-9 sm:w-9 text-[#0F172A] hover:bg-[#F8FAFC] dark:text-[#F5F5F5] dark:hover:bg-[#1F1F1F]" },
                    ...
                    react_2["default"].createElement(sheet_1.SheetContent, { side: "left", className: "flex w-[300px] flex-col border-r border-[#E2E8F0] bg-white p-0 dark:border-[#2A2A2A] dark:bg-[#0D0D0D]" },
                        react_2["default"].createElement(sheet_1.SheetHeader, { className: "border-b border-[#E2E8F0] px-6 py-4 dark:border-[#2A2A2A]" },
                            react_2["default"].createElement(sheet_1.SheetTitle, { className: "flex items-center gap-2" },
                                react_2["default"].createElement("img", { src: "/images/logo/logo_version_light_2.png", className: "h-20 w-auto dark:hidden", alt: "HiLights Football" }),
                                react_2["default"].createElement("img", { src: "/images/logo/logo_version_light_2.png", className: "hidden h-20 w-auto dark:block", alt: "HiLights Football" }))),
